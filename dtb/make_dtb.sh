...
main() {
    local linux='https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/snapshot/linux-6.6-rc1.tar.gz'
    local lxsha='cd82d76c93d8dfd564524a70bd619389dda919d642629554aa1754b9726ecf95'
