...
**1. download image**
```
wget https://github.com/inindev/rock-5b/releases/download/v13-6.7-rc4/rock-5b_trixie-v13-6.7-rc4.img.xz
```
...
```
sudo su
xzcat rock-5b_trixie-v13-6.7-rc4.img.xz > /dev/sdX
sync
```
...
wget https://github.com/inindev/rock-5b/releases/download/v13-6.7-rc4/rock-5b_trixie-v13-6.7-rc4.img.xz
sudo su
xzcat rock-5b_trixie-v13-6.7-rc4.img.xz > /dev/nvme0n1
sync
```
